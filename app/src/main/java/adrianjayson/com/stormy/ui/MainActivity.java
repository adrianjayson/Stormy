...
import adrianjayson.com.stormy.R2;
import adrianjayson.com.stormy.weather.Current;
import adrianjayson.com.stormy.weather.Day;
import adrianjayson.com.stormy.weather.Forecast;
import adrianjayson.com.stormy.weather.Hour;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final double latitude = 14.554592;
        final double longtitude = 121.0156373;
    ...
    private Forecast parseForecastDetails(String jsonData) throws JSONException {
        ...
        forecast.setHourlyForecast(getHourlyData(jsonData));
        forecast.setDailyForecast(getDailyData(jsonData));
